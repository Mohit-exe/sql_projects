...
#table books
create table books(bookid int primary key,title varchar(200),authorid int,genre varchar(50),
publishyear year,foreign key(authorid) references authors(authorid));
...
#table loans
create table loans(loanid int primary key,bookid int,memberid int,loandate date,returndate date,
...
(1,"jkrowling","uk"),
(2,"george rr martin","usa"),
(3,"jrr tolkien","uk"),
(4,"robin sharma","india"),
(5,"ved vyas","india"),
(6,"munshi premchand","india");

insert into books values
(1,"harry potter",1,"fantasy",1997),
(2,"game of thrones",2,"fantasy",1996),
(3,"the lord of the rings",3,"fantasy",1937),
(4,"extraordinary leadership",4,"motivational",2006),
(5,"ramayan",5,"history",2000),
(6,"godan",6,"story",1936);

insert into members values
(1,"alice","alice@gmail.com","2022-01-15"),
(2,"bob","bob@gmail.com","2022-02-15"),
(3,"sam","sam@gmail.com","2022-02-10"),
(4,"ram","ram@gmail.com","2022-02-06"),
(5,"rahim","rahim@gmail.com","2022-01-10"),
(6,"ajay","ajay@gmail.com","2022-01-13");


insert into loans values
(1,1,1,"2023-06-01","2023-06-15"),
(2,2,2,"2023-06-05","2023-06-20"),
(3,3,3,"2023-06-10","2023-06-30"),
(4,4,4,"2023-06-15","2023-07-05"),
(5,5,5,"2023-06-20","2023-07-10"),
(6,6,6,"2023-06-26","2023-07-16");
